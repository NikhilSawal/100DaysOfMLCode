...
(23.06428, 0.6648412, 0.638657)
* Notice that, though Model 2 looks better than Model 3, in terms of values of 
`(MSE, R^2, Adjusted R^2)`, for a reduction of 10 predictor variables from Model 2 -> Model 3, there is very little improvement in the values of `(MSE, R^2, Adjusted R^2)`. Infact, the values of `Adjusted R^2` for the two models are approximately the same (~64%). So Model 3 is way better than Model 2, since it uses half the predictors as compared to Model 2 and has comparable level of accuracy.
